...
**Шаг 8: Админ-панель модерации** — рассмотрение `moderation_requests` и
`driver_documents`, выставление `approved`/`rejected` + причина,
управление пользователями. См. `claude_code_promts.md`, Часть 8.
